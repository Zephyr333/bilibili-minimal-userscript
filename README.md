...
- On search pages, keep search type tabs, filters, result cards, and pagination; hide hot search, ads, activity promotions, footer, login prompts, and everything below pagination.
